...
https://blog.csdn.net/u012426327/article/details/77670190
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此文档将着重关注开发与测试两个核心过程，并以软件开发项目中开发和测试团队间的协作为基础，来介绍源代码管理、项目管理过程、开发过程、报告分析等内容，使开发团队能够更加有效地进行协作。下图简单的概括本文所述内容：
